    ...
    <ul class="navbar-nav ml-auto">
     ...
     <li class="nav-item dropdown">
            ...
            <div class="dropdown-menu" aria-labelledby="account_settings" style="left: -2.5em;">
              <a class="dropdown-item" href="javascript:void(0)" id="manage_account"><i class="fa fa-cog"></i> Paramètres du compte</a>
              <a class="dropdown-item" href="ajax.php?action=logout"><i class="fa fa-power-off"></i> Se déconnecter</a>
            </div>
      </li>
    </ul>
  </nav>
