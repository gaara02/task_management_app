...
$stat = array("En cours","débuté","En progression","En attente","En retard","terminé");
...
<div class="col-lg-12">
						...
						<div class="col-md-6">
							...
							<dl>
								...
								<dd>
									<?php
									  ...
									  }elseif($stat[$status] =='débuté'){
									  	echo "<span class='badge badge-primary'>{$stat[$status]}</span>";
									  }elseif($stat[$status] =='En progression'){
							...
							<dl>
								...
								<dd>
									...
									<?php else: ?>
										<small><i>Manager supprimé de la base de donnée</i></small>
									<?php endif; ?>
								</dd>
							</dl>
						</div>
	...
	<div class="row">
		<div class="col-md-12">
			<div class="card">
				<div class="card-header">
					<b>Progression des membres/Activités</b>
					<div class="card-tools">
						<button class="btn btn-primary bg-gradient-primary btn-sm" type="button" id="new_productivity"><i class="fa fa-plus"></i> nouvelle progression</button>
					</div>
				</div>
				<div class="card-body">
					<?php 
		                      ...
		                      <div class="user-block">
		                        ...
		                        <span class="description">
		                        	...
		                        	<span class="fa fa-user-clock"></span>
                      				<span>Debut: <b><?php echo date('h:i A',strtotime($row['date'].' '.$row['start_time'])) ?></b></span>
		                        	<span> | </span>
